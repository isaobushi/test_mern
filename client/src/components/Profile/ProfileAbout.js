...
class ProfileAbout extends Component {
	render() {
		...
		const courses = profile.courses.map((course, index) => {
			return (
				<div key={index} className="p-3">
			...
			<div className="row">
				<div className="col-md-12">
					<div className="card card-body bg-light mb-3">
						...
						<hr />
						<h3 className="text-center text-info">Exercises</h3>
						<div className="row">
							<div className="d-flex flex-wrap justify-content-center align-items-center">{courses}</div>
						</div>
					</div>
				</div>
			</div>
